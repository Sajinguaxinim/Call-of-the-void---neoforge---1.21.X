...
public class CallOfTheVoid {
    ...
    public CallOfTheVoid(IEventBus modEventBus, ModContainer modContainer) {
    ...
    @EventBusSubscriber(modid = CallOfTheVoid.MOD_ID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
